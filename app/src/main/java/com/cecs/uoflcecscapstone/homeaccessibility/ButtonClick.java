...
public class ButtonClick {
    public String getRequest() throws Exception {
        ...
        try {
            ...
            Scheme register = client.getConnectionManager().getSchemeRegistry().register(getMockedScheme());

            HttpGet request = new HttpGet();
            request.setURI(DoorActivity.website);
    ...
    public Scheme getMockedScheme() throws Exception {
        ...
        return new Scheme("https", (org.apache.http.conn.scheme.SocketFactory) mySSLSocketFactory, 8080);
    }
